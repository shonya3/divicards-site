    ...
    return html`
      <article>
        ...
        <section id="section-1">
          ...
          <ul>
            <li>The card dropped may include global/drop-anywhere cards (e.g. her mask, the dragon's heart)</li>
        ...
        <section id="section-2">
          ...
          <ul>
            ...
            <li>
              <a href="https://getsharex.com/">ShareX - Screen capture, file sharing and productivity tool</a>
            </li>
            <li>
        ...
        <section id="section-3">
          ...
          <img src="/images/verify-faq/need-to-verify.jpg" alt="showcase of need-to-verify sources from divcord page" />
