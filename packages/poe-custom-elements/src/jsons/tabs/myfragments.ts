...
export const fragments: TabWithItems = {
  ...
  items: [
    ...
    },
    {
      ...
      descrText: "Can be used in a personal Map Device to add modifiers to a Map.",
      explicitMods: ["Using a Remnant of Corruption in Area can only result in\nupgrading or transforming Essences"],
      flavourText: [
    ...
    },
    {
      ...
      descrText: "Can be used in a personal Map Device to add modifiers to a Map.",
      explicitMods: ["Tormented Spirits in Area have a 25% chance to\nbe set free when Possessed Monsters are slain"],
    ...
    },
    {
      ...
      descrText: "Can be used in a personal Map Device to add modifiers to a Map.",
      explicitMods: ["Defeated Immortal Syndicate targets in Area have a 50% chance\nto drop an additional Scarab"],
    ...
    },
    {
      ...
      flavourText: ["It is time for the Goddess to give her final verdict.\r", "Your fate rests in her even hands."],
      frameType: 0,
      h: 1,
    ...
    },
    {
      ...
      flavourText: ["Before the Goddess, nothing remains hidden.\r", "Adversity reveals old flaws and new strengths."],
      frameType: 0,
      h: 1,
    ...
    },
    {
      ...
      descrText: "Use five of these in a personal Map Device to open Portals to The Cortex. Can only be used once.",
      explicitMods: ["The Cortex is level 85\r\nVenarius' full power is unleashed in the Cortex"],
      flavourText: ["When memories become twisted by a corrupted mind,\r", " history is rewritten, time after time."],
      frameType: 0,
      h: 1,
    ...
    },
    {
      ...
      descrText: "Travel to the Aspirants' Plaza and spend this item to open the Eternal Labyrinth of Opportunity.",
    ...
    },
    {
      ...
      flavourText: ["From the heart of the Tangle, the Eater of Worlds\r", "reaches out for control of the Atlas."],
      frameType: 0,
      h: 1,
