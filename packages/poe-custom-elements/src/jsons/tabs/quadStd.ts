...
export const quadStd: TabWithItems = {
  ...
  items: [
    ...
    },
    {
      ...
      explicitMods: ["Adds an incubated Fossil item to an equippable item\r\nItem drops after killing 8924 monsters"],
      frameType: 5,
      h: 1,
    ...
    },
    {
      ...
      descrText:
        "Right click this item then left click an item to apply it. The Incubated item drops after killing a specific number of monsters.",
      explicitMods: ["Adds an incubated Breach item to an equippable item\r\nItem drops after killing 10407 monsters"],
      frameType: 5,
      h: 1,
    ...
    },
    {
      ...
      explicitMods: ["Supported Skills deal 38% more Area Damage", "Supported Skills have 30% less Area of Effect"],
      frameType: 4,
      h: 1,
    ...
    },
    {
      baseType: "Gold Ring",
      cisRaceReward: true,
      explicitMods: ["+10 to Dexterity", "65% increased Rarity of Items found", "-20% to all Elemental Resistances"],
    ...
    },
    {
      ...
      socketedItems: [
        ...
        },
        {
          ...
          secDescrText: "Casts an aura that adds fire damage to the attacks and spells of you and your allies.",
          socket: 1,
          support: false,
          typeLine: "Anger",
          verified: false,
    ...
    },
    {
      ...
      socketedItems: [
        ...
        },
        {
          ...
          secDescrText: "Supports any skill that has a duration, or can hit enemies to inflict ailments on them.",
          socket: 3,
          support: true,
    ...
    },
    {
      ...
      descrText: "Right click to drink. Can only hold charges while in belt. Refills as you kill monsters.",
      explicitMods: ["25% reduced Charges per use", "0.4% of Physical Attack Damage Leeched as Mana during Effect"],
      frameType: 1,
      h: 2,
    ...
    },
    {
      baseType: "Basalt Flask",
      descrText: "Right click to drink. Can only hold charges while in belt. Refills as you kill monsters.",
      explicitMods: ["25% reduced Charges per use", "Grants Immunity to Shock for 4 seconds if used while Shocked"],
      frameType: 1,
      h: 2,
      icon: "https://web.poecdn.com/gen/image/WzksMTQseyJmIjoiMkRJdGVtcy9GbGFza3Mvc3RvbmUiLCJ3IjoxLCJoIjoyLCJzY2FsZSI6MSwibGV2ZWwiOjF9XQ/00261d09db/stone.png",
    ...
    },
    {
      ...
      explicitMods: ["+30 to Dexterity", "23% increased Cold Damage", "+85 to maximum Life", "+46% to Cold Resistance"],
      frameType: 2,
      h: 1,
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/841", 0]] }],
    ...
    },
    {
      ...
      explicitMods: ["Adds 18 to 37 Physical Damage", "23% increased Attack Speed", "Gain 2 Mana per Enemy Killed"],
      frameType: 2,
      h: 2,
    ...
    },
    {
      ...
      corrupted: true,
      explicitMods: ["Sockets cannot be modified", "+1 to Level of Socketed Gems", "100% increased Global Defences"],
      flavourText: [
    ...
    },
    {
      ...
      socketedItems: [
        ...
        },
        {
          ...
          descrText:
            "This is a Support Gem. It does not grant a bonus to your character, but to skills in sockets connected to it. Place into an item socket connected to a socket containing the Skill Gem you wish to augment. Right click to remove from a socket.",
          explicitMods: ["Supported Skills deal 37% more Area Damage", "Supported Skills have 30% less Area of Effect"],
          frameType: 4,
          h: 1,
          icon: "https://web.poecdn.com/gen/image/WzI1LDE0LHsiZiI6IjJESXRlbXMvR2Vtcy9TdXBwb3J0L0NvbmNlbnRyYXRlZEFPRSIsInciOjEsImgiOjEsInNjYWxlIjoxfV0/4db641d292/ConcentratedAOE.png",
    ...
    },
    {
      ...
      socketedItems: [
        ...
        },
        {
          ...
          secDescrText: "Casts an aura that grants extra cold damage based on physical damage to you and your allies.",
          socket: 2,
          support: false,
          typeLine: "Hatred",
          verified: false,
    ...
    },
    {
      ...
      descrText:
        "Place into an allocated Jewel Socket on the Passive Skill Tree. Right click to remove from the Socket.",
      explicitMods: ["Summon 2 additional Skeletons with Summon Skeletons", "+1 second to Summon Skeleton Cooldown"],
      flavourText: [
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/118383", 0]] }],
      baseType: "Hatred",
      descrText:
        "Place into an item socket of the right colour to gain this skill. Right click to remove from a socket.",
      explicitMods: [
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/15249", 0]] }],
      baseType: "Storm Call",
      descrText:
        "Place into an item socket of the right colour to gain this skill. Right click to remove from a socket.",
      explicitMods: [
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/3231", 0]] }],
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/388734", 0]] }],
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/199345", 0]] }],
    ...
    {
      additionalProperties: [{ displayMode: 2, name: "Experience", progress: 0, type: 20, values: [["1/69833", 0]] }],
      baseType: "Shockwave Support",
      descrText:
        "This is a Support Gem. It does not grant a bonus to your character, but to skills in sockets connected to it. Place into an item socket connected to a socket containing the Skill Gem you wish to augment. Right click to remove from a socket.",
      explicitMods: [
    ...
    },
    {
      ...
      descrText:
        "This is a Support Gem. It does not grant a bonus to your character, but to skills in sockets connected to it. Place into an item socket connected to a socket containing the Skill Gem you wish to augment. Right click to remove from a socket.",
      explicitMods: ["Supported Skills deal 19% more Damage", "Supported Skills have 59% less Skill Effect Duration"],
      frameType: 4,
      h: 1,
