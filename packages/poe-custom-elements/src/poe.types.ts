...
export type PoeItem = {
  ...
  stackSize?: number;
  /**
   * Textual representation of the stack size for display purposes. This property will be present on items that have
   * 5-digit stack sizes (ie. > 9999). https://www.pathofexile.com/forum/view-thread/2936225
   */
